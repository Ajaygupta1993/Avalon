...
function submitEnq(){
	...
	var selectCrs=$("#selectCrs").val();
	var Qualification=$("#Qualification").val();
	var year=$("#year").val();
	var Src=$("#Src").val();
	var StDmnd=$("#StDmnd").val();
	...
	$.ajax({
		...
		url:ctxPath+"/Master/Ajax/submitEnq",
		type:"POST",
		data:{CN:cndName,MN:mobNo,EM:email,SD:selectDom,SC:selectCrs,QUA:Qualification,YR:year,SR:Src,STD:StDmnd,COM:comment,DT:Date,TI:Time},
			...
			<div class="modal-body" style="background-color: #FCFCFC">
				...
				<div class='row' style="margin-bottom: 10px">
					<div class='col-xs-12'>
						...
						<div class='row' style="margin-bottom: 10px">
							<div class='col-xs-36'>
								<input placeholder="Enter Candidate Name"id="cndName" type='text'
						...
						<div class='row' style="margin-bottom: 10px">
							<div class='col-xs-36'>
								<input placeholder="Mobile Number"id="mobNo" type='text'
									class="form-control input-lg" />
							</div>
						</div>
						...
						<div class='row' style="margin-bottom: 10px">
							<div class='col-xs-36'>
								<input placeholder="EmailId" type='text' id="email"
									class="form-control input-lg" />
							</div>
						</div>


						<div class='row' style="margin-bottom: 10px"id="selectDom">
							<div class='col-xs-18'>
							...
							<div class='col-xs-18'id="selectCrs">
								<select class="form-control input-lg" >
						...
						<div class='row' style="margin-bottom: 10px"id="Qualification">
							...
							<div class='col-xs-18' style="margin-bottom: 10px" id="year">
								<select class="form-control input-lg">
									<option>Year</option>
							...
							<div class='col-xs-18' style="margin-bottom: 10px" id="Src">
								<select class="form-control input-lg">
					...
					<div class='col-xs-24'>
						<input style='margin-bottom: 10px'
							placeholder="Student Demanded details" type='text' id="StDmnd"
							class='form-control input-lg' />

						<textarea rows="5" style='margin-bottom: 10px' id="comment"
						...
						<div class='row' style="margin-bottom: 10px" >
							...
							<div class='col-xs-12' style="padding-left: 0px" id="Date">
							...
							<div class='col-xs-8' style="padding-right: 0px" id="Time">
								<div class="input-group">
						...
						<div class='row' style="margin-bottom: 10px">
							...
							<div class='col-xs-18'>
								<input type="checkbox" id="visitor"> Visiter
							</div>
							<div class='col-xs-18'>
								<div class='text-right'>
									<button class='btn btn-primary'onclick="submitEnq()">Submit Enquiry</button>
