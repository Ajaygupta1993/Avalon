	...
	<section style='display: none'>
		...
		<div class='av-row av-row-89'>
			<div class='container-fluid'>
				<div class='row'>
					<div class='col-xs-10 av-row' style='background-color: #FCFCFC'>
						<div class='row'>

							<div class='col-xs-4 av-row' id='leftToolar'
								style="padding: 0px; border-right: 1px solid #111">
								<div class="left-toolbar av-row active"
									id='student-left-toolbar'>
									<div stdDisplayItem='1' class="fa fa-user fa-2x active"></div>
									<div stdDisplayItem='2' class="fa fa-calculator fa-2x"></div>
									<div stdDisplayItem='3' class="fa fa-dashcube fa-2x"></div>
								</div>
								<div class="left-toolbar av-row" id='enq-left-toolbar'>
									<div stdDisplayItem='1' class="fa fa-trash fa-2x active"></div>
									<div stdDisplayItem='2' class="fa fa-calculator fa-2x"></div>
									<div stdDisplayItem='3' class="fa fa-dashcube fa-2x"></div>
								</div>
								<div class="left-toolbar av-row" id='batch-left-toolbar'>
									<div batchDispItem='1' class="fa fa-user fa-2x active"></div>
									<div batchDispItem='2' class="fa fa-calculator fa-2x"></div>
									<div batchDispItem='3' class="fa fa-dashcube fa-2x"></div>
								</div>

							</div>
							<div class='col-xs-32 av-row' style='padding: 0px'>
								<div class='av-row' style='border-right: 1px solid #666'>
									<div class='av-row-4 bg-strip' id='search-tab'>
										<label class='active' toolbar='#student-left-toolbar'
											href='#studentSearch'>Student</label> <label
											href='#enquerySearch' toolbar='#enq-left-toolbar'>Enquiry</label>
										<label href='#batchSearch' toolbar='#batch-left-toolbar'>Batch</label>
									</div>
									<div class='av-row-96 search-tab-panel' id='studentSearch'>
										<jsp:include page="StudentSearch.jsp"></jsp:include>
									</div>
									<div style="display: none;" class='av-row-96 search-tab-panel'
										id='enquerySearch'>
										<jsp:include page="EnquirySearch.jsp"></jsp:include>
									</div>
									<div style="display: none;" class='av-row-96 search-tab-panel'
										id='batchSearch'>
										<jsp:include page="BatchSearch.jsp"></jsp:include>
									</div>
								</div>
							</div>
						</div>
					...
					<div class='col-xs-26 av-row' style='padding: 0px;'>
						<div class='av-row-4 d-tabs'>
							<span id='tabs' class="av-row"> <span id='default-tab'
								class='tab-trigger active' style="margin-right: -3px" href='#1'>
									<tab-name>Home</tab-name>
							</span>
							</span> <span title='New Tab (Max 6 tabs)' id='btnAddNewTab'
								onclick='addNewTab(this);'> <i class='fa fa-plus-square'></i>
							</span>

						</div>
						<div id='tab-panels' style='padding: 0px;' class='av-row-96'>
							<decorator:body />
						</div>
					</div>
				</div>
